...
SYSTEM_PROMPT = (
    ...
    "If the context does not actually answer the question, clearly say the "
    "information is not available in the portfolio — do not guess.\n"
    "When helpful, mention which portfolio project or experience supports your answer.\n"
    "Answer in {language}. Keep it SHORT: 2–4 sentences, direct and specific. "
    "Do not repeat the question, do not add filler, do not dump the whole context.\n"
